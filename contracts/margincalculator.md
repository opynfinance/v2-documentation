...
marginRequired = \( option upper bound value  _a + b\)_  short amount
...
marginRequired = max\( \(short amount  _short strike\) - \(long strike_  min \(short amount, long amount\)\) , 0 \)
...
Formula: net = \(short cash value  _short amount\) - \( long cash value_  long Amount \)
